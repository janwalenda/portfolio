...
export type PageBuilder = Array<{
  ...
  _weak?: boolean;
  _key: string;
  [internalGroqTypeReferenceTo]?: "grid";
} | {
  _key: string;
} & TextBlock>;
...
export type AllSanitySchemaTypes = FooterColBuilder | GridBuilder | Grid | TextBlock | Card | Post | BlockContent | SanityImageCrop | SanityImageHotspot | Slug | Author | Category | Page | PageBuilder | Features | Faqs | Faq | Hero | Link | Icon | SplitImage | SiteSettings | Code | SanityImagePaletteSwatch | SanityImagePalette | SanityImageDimensions | SanityImageMetadata | SanityFileAsset | SanityAssetSourceData | SanityImageAsset | Geopoint;
export declare const internalGroqTypeReferenceTo: unique symbol;
// Source: ./sanity/lib/blog/getAllPosts.ts
// Variable: GET_ALL_POSTS_QUERY_ASC
// Query: *[_type == "post"] | order(title asc)
...
// Query: *[_type == "post"] | order(title desc)
...
// Query: *[          _type == "post" && slug.current == $slug        ] | order(name asc)[0]
...
// Source: ./sanity/lib/page/getGridByID.ts
// Variable: GET_GRID_BY_ID_QUERY
// Query: *[_type == "grid" && _id == $id][0]{    ...,    components[] -> {      ...,      action[]->    }  }
export type GET_GRID_BY_ID_QUERYResult = {
  _id: string;
  _type: "grid";
  _createdAt: string;
  _updatedAt: string;
